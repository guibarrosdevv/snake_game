...
// Obtendo pontuação alta no armazenamento local
...
const handleGameOver = () => {
    ...
    alert("Game Over! Precione OK para jogar novamente...");
    location.reload();
}
...
// Chamando changeDirection em cada clique de tecla e passando o valor do conjunto de dados chave como um objeto
...
const initGame = () => {
    ...
    // Avançando os valores dos elementos no corpo da cobra em um
...
updateFoodPosition();
setIntervalId = setInterval(initGame, 135);
